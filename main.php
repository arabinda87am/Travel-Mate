...
<html>
    ...
    <body>
        ...
        if($transit=='driving')
        {
            $url = 'https://maps.googleapis.com/maps/api/distancematrix/json?origins='.$autocomplete.'&destinations='.$autocomplete1.'&key=AIzaSyCVsy8x-DICFF_DUdoVWeGkMiYAOwUHafQ';
        }
        else
        {
            $url = 'https://maps.googleapis.com/maps/api/distancematrix/json?origins='.$autocomplete.'&destinations='.$autocomplete1.'&mode=transit&transit_mode=train&key=AIzaSyCVsy8x-DICFF_DUdoVWeGkMiYAOwUHafQ';
        }
        ...
        $url2= 'https://maps.googleapis.com/maps/api/place/textsearch/json?query=point_of_interest+in+'.$autocomplete1.'&key=AIzaSyD3gNcAxy6KaC04KXYfkesEuKhyQIa66PE';
        $ch2 = curl_init();
        ...
        $url1= 'https://maps.googleapis.com/maps/api/place/textsearch/json?query=restaurants|hotels+in+'.$autocomplete1.'&radius=1000&key=AIzaSyD88bvgrgKpIeuKYCZRD5qRD9o3CrGhdMw';
